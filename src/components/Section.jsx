...
import { Box, Typography, Container, Card, CardContent, CardMedia, CardActions, Button } from "@mui/material";
                        ...
                        <div className="flex flex-wrap w-full max-w-screen-lg" style={{ height: "80vh" }}>
                            <div className="flex-1 min-w-[300px] p-4 flex flex-col justify-around">
                                <div>
                                    ...
                                    <Typography variant="h3">Este es nuestro equipo de trabajo!</Typography>
                                </div>
                            ...
                            <div className="flex-1 min-w-[300px] p-4 flex flex-col gap-4 justify-center">
                                ...
                                <div className="bg-gray-700 p-4 flex-1">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <img alt="" src={franco} className="inline-block h-20 w-20 rounded-full ring-2 ring-white" />
                                        <Typography variant="h6">Full Stack WEB</Typography>
                                    </div>
                                    <div className="flex justify-between mt-4 items-end">
                                        <ul className="list-none ml-4 mt-2">
                                            ...
                                            <li className="flex items-center">
                                                <CheckIcon className="h-5 w-5 text-green-500 mr-2" />4 Años de experiencia freelance
                                            </li>
                                        </ul>
                                        <div className="ml-4 mt-2 flex flex-col gap-2 h-full">
                                            <button className="flex items-center bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
...
function ProjectCard({ title, description, image, githubLink, previewLink }) {
    return (
        ...
        >
            ...
            <CardContent>
                <Typography gutterBottom variant="h5" component="div" sx={{ color: "#ff7e5f", fontWeight: "bold" }}>
                    {title}
                </Typography>
            ...
            <CardActions>
                <Button size="small" href={githubLink} target="_blank" startIcon={<GitHubIcon />} sx={{ color: "white" }}>
                    GitHub
                </Button>
                <Button size="small" href={previewLink} target="_blank" startIcon={<PreviewIcon />} sx={{ color: "white" }}>
                    Preview
                </Button>
            </CardActions>
        </Card>
